...
<!-- css -->
<link href="${url}/css/exercise/exercise.css" rel="stylesheet" type="text/css" />
<!-- 카카오 api 라이브러리  -->
...
<form method="post" action="/exercise/every_exerciseWriteOk" id="everyexerciseFrm">
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="today-keyword" placeholder="#하체 #스쿼트">
    ...
    <div class="form-group" >
      ...
      운동시작일 : <input type="date" class="form-control" id="exercise-sdate" name="startdate">
      운동종료일 : <input type="date" class="form-control" id="exercise-edate" name="enddate">
      </div>
    </div>
