...
<body>
	<div class="container" id="every-exercise-mainFrm">
		<form method="post" action="/exercise/every_exerciseEditOk" id="every-exerciseFrm">
			<fieldset>
				...
				<div>
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="title" placeholder="${vo.title}">
						</div>
					</div>
					...
					<div class="form-group">
						<label for="exercise-date" class="form-label mt-4">운동날짜</label> <input
							type="date" class="form-control" id="exercise-date" name="startdate"> <input
							type="date" class="form-control" id="exercise-date" name="enddate">
					</div>
